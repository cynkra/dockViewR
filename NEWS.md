...
- Bumped `dockview-core` to v6.2.2. The `"replit"` theme was removed upstream (see [dockview v6 migration guide](https://dockview.dev/docs/overview/whats-new-v6)); pass another theme (e.g. `"light-spaced"`) instead.
