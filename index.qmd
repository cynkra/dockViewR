...
dockViewR:::print_r_code("examples/update_theme/app.R")
```
</details>
...
To contribute to this project, you'll need `npm`, `node`, and the R package `{packer}` to compile the JavaScript code. Please follow the guide [here](https://packer.john-coene.com/#/guide/installation). When you are in the project, do the following:
