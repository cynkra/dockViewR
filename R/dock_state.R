...
#' [get_active_group()] extracts the `activeGroup` component of [get_dock()] as a string.
...
#' [save_dock()] and [restore_dock()] are used for their side effect to allow to respectively
