...
[dockViewR](https://github.com/cynkra/dockViewR), feel free to submit
issues, feature requests, or pull requests.

### Knowledge pre-requisites

[dockViewR](https://github.com/cynkra/dockViewR) is an **htmlwidget**,
an interactive widget for R, powered by a JS library. To get a minimum
starting kit:
...
1.  Whenever you run an app using
    [dockViewR](https://github.com/cynkra/dockViewR), like in
